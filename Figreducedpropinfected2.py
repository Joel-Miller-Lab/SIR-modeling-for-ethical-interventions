...
graphmaker(R0, c, num_saved_per_person, '', 'Starting reproduction number', 'Proportion of infected people who isolate', 'Number of infections prevented \n per isolating individual', 1e-3, 1e3, [1e-2, 1e-1, 1, 10, 1e2], norm='log')

plt.savefig('ManyPeopleIsolating.png')

num_saved_by_one_more_isolating = R0*(1 - prop_infected_c)/(1 - Rc*(1 - prop_infected_c))

graphmaker(R0, c, num_saved_by_one_more_isolating, '', 'Starting reproduction number', 'Proportion of infected people who isolate', 'Number of infections prevented by \n one more person isolating', 1e-1, 1e3, [0.1, 0.3, 1, 3, 10, 100], norm='log')
